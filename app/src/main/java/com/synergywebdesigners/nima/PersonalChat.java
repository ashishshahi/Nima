...
/**
 * Created by Ashish Shahi on 06-04-2017.
 */

public class PersonalChat extends AppCompatActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
  ...
  //  int id = getResources().getIdentifier("yourpackagename:drawable/" + StringGenerated, null, null);
   ...
   //Remember This    // doTheAutoRefresh();//calling Refresh method on Resume Event Because When I am Open Application Activity Automatically started.
       /* *//*screen Not lock this code*//*
        ...
        *//*End of Screen Lock*/
        ...
        Picasso.with(PersonalChat.this).load("http://synergywebdesigners.com/synergywebdesigners.com/ashish/nimadesktop/admin/"+img).transform(new CircleTransform()).into(img1);
        title.setText(name);
    ...
    private void addMessage(){
        ...
        class AddMessage extends AsyncTask<Void,Void,String> {
            ...
            protected void onPostExecute(String s) {
                ...
                // loading.dismiss();
                Toast.makeText(PersonalChat.this,s, Toast.LENGTH_SHORT).show();
            }
    ...
    private void showMesage(){
        ...
        ListAdapter adapter = new SimpleAdapter(PersonalChat.this, list, R.layout.layout_message,
